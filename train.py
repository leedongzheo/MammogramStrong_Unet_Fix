...
def get_args():
    ...
    """
    parser.add_argument("--loss", type=str, choices=["Dice_loss", "Hybric_loss", "BCEDice_loss", "BCEwDice_loss", "BCEw_loss", "SoftDice_loss"], default="Hybric_loss", help="Hàm loss sử dụng, default = Hybric_loss")
